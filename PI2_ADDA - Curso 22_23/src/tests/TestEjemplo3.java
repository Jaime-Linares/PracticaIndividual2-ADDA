...
public class TestEjemplo3 {
	...
	private static Integer sizeMin = 100; // tamano minimo de lista
	private static Integer sizeMax = 100000; // tamano maximo de lista
	private static Integer numSizes = 50; // numero de tamanos de listas
	private static Integer minValue = 0; 
	private static Integer maxValue = 1000000;
	private static Integer numListPerSize = 1; // numero de listas por cada tamano  (UTIL???) -> lo requiere pero no nos afecta
	private static Integer numCasesPerList = 30; // numero de casos (elementos a buscar) por cada lista 
	private static Random rr = new Random(System.nanoTime()); // para inicializarlo una sola vez y compartirlo con los metodos que lo requieran

	// Parametros de medicion
	private static Integer numMediciones = 5; // numero de mediciones de tiempo de cada caso (numero de experimentos)
	private static Integer numIter = 50; // numero de iteraciones para cada medicion de tiempo
	private static Integer numIterWarmup = 100000; // numero de iteraciones para warmup
	...
	// 		- Elementos que SÍ estan todos en las listas
	//		- Elementos que NO estan en las listas
