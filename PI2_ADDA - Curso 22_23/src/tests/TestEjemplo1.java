...
public class TestEjemplo1 {
	...
	private static Integer nMin = 50; // n minimo para el calculo de potencia
	private static Integer nMax = 100000; // n maximo para el calculo de potencia
	private static Integer numSizes = 50; // numero de problemas (numero de potencias distintas a calcular)
	...
	// El primer elemento del trio es el algoritmo en si
