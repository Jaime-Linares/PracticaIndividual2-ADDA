...
public class TestEjemplo2 {
	...
	private static Integer nMin = 2; // n minimo
	private static Integer nMaxRec = 50; // n maximo para el fibonacci recursivo sin memoria 
	private static Integer nMaxIter = 100000; // n maximo para el fibonacci no exponencial
	private static Integer numSizes = 30; // numero de problemas
	private static Integer numMediciones = 10; //10; // numero de mediciones de tiempo de cada caso (numero de experimentos)
												// para exponencial se puede reducir 
	private static Integer numIter = 50; //50; // numero de iteraciones para cada medicion de tiempo
											// para exponencial se puede reducir 
	private static Integer numIterWarmup = 1000; // numero de iteraciones para warmup
