...
import utils.MatrixFibBigInteger;
import utils.MatrixFibDouble;

public class Ejemplo2 {
	/*
	PI2 - Ejemplo 2

	Analizar los tiempos de ejecucion de las versiones recursivas sin y con memoria, 
	iterativa y haciendo uso de la potencia de matrices para el calculo de los 
	numeros de Fibonacci. 
	
	Comparar segun los resultados sean de tipo Double o BigInteger.
	*/
	 ...
	 * @pre n &gt; = 0
	 * @param n Un Entero
	 * @return El numero n de Fibonacci calculado reduciendo el problema a una potenciacion de matrices
	 * y en una version iterativa
	 */
